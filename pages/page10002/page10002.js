...
Page({
  ...
  formSubmit:function(e){
    this.setData({
      ...
      p_num:e.detail.value.p_num,
      s_num:e.detail.value.s_num,
      level:e.detail.value.level,
      enter_year:e.detail.value.enter_year
    })
  ...
  onLoad: function (options) {
    wx.request({
      url: 'http://119.29.253.254:8000/api/auth?openid='+app.globalData.token,
      method:'GET',
      data:{},
      ...
      success:function(res){
       this.setData({
         ...
         s_num:res.data.s_num,
         level:res.data.level,
         enter_year:res.data.enter_year
       }) 
      }
    })
  },
